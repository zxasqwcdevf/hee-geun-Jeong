...
public class TestController {
	...
	// @RequestMapping(value="testC", method = {RequestMethod.GET, RequestMethod.POST})
	...
	public String testD(
			String msg,
			@RequestParam(name="msg", required=false, defaultValue="default")
			String message,
			@RequestParam(name="msg", required=true) String msgg
		) {
		System.out.println("msg : " + msg);
		System.out.println("message : " + message);
		System.out.println("mesgg : " + msgg);
		return "result";
	}
